...
impl TryFrom<&str> for BinaryOp {
    ...
    fn try_from(s: &str) -> Result<Self, ()> {
        match s {
            ...
            "/=" => Ok(Self::DivAssign),
            "%=" => Ok(Self::ModAssign),
            "<<=" => Ok(Self::LeftLogicalShiftAssign),
            ">>=" => Ok(Self::RightLogicalShiftAssign),
            "<<<=" => Ok(Self::LeftArithmeticShiftAssign),
            ">>>=" => Ok(Self::RightArithmeticShiftAssign),
...
impl TryFrom<&str> for IoMethod {
    ...
    fn try_from(s: &str) -> Result<Self, ()> {
        match s {
            ...
            "input_bit_offset" => Ok(Self::InputBitOffset),
...
impl TryFrom<&str> for OrderType {
    ...
    fn try_from(s: &str) -> Result<Self, ()> {
        match s {
            "byte" => Ok(Self::Byte),
            "bit_stream" => Ok(Self::BitStream),
            "bit_mapping" => Ok(Self::BitMapping),
            "bit_both" => Ok(Self::BitBoth),
            _ => Err(()),
        }
    }
}
...
impl TryFrom<&NodeWeak> for Node {
    ...
    fn try_from(node: &NodeWeak) -> Result<Self, Self::Error> {
        match node {
            NodeWeak::Program(node) => Ok(Self::Program(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Program))?,
            )),
            NodeWeak::Comment(node) => Ok(Self::Comment(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Comment))?,
            )),
            NodeWeak::CommentGroup(node) => Ok(Self::CommentGroup(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::CommentGroup))?,
            )),
            NodeWeak::FieldArgument(node) => Ok(Self::FieldArgument(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::FieldArgument))?,
            )),
            NodeWeak::Binary(node) => Ok(Self::Binary(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Binary))?,
            )),
            NodeWeak::Unary(node) => Ok(Self::Unary(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Unary))?,
            )),
            NodeWeak::Cond(node) => Ok(Self::Cond(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Cond))?,
            )),
            NodeWeak::Ident(node) => Ok(Self::Ident(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Ident))?,
            )),
            NodeWeak::Call(node) => Ok(Self::Call(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Call))?,
            )),
            NodeWeak::If(node) => Ok(Self::If(
                node.upgrade().ok_or(Error::InvalidNodeType(NodeType::If))?,
            )),
            NodeWeak::MemberAccess(node) => Ok(Self::MemberAccess(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::MemberAccess))?,
            )),
            NodeWeak::Paren(node) => Ok(Self::Paren(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Paren))?,
            )),
            NodeWeak::Index(node) => Ok(Self::Index(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Index))?,
            )),
            NodeWeak::Match(node) => Ok(Self::Match(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Match))?,
            )),
            NodeWeak::Range(node) => Ok(Self::Range(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Range))?,
            )),
            NodeWeak::Identity(node) => Ok(Self::Identity(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Identity))?,
            )),
            NodeWeak::TmpVar(node) => Ok(Self::TmpVar(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::TmpVar))?,
            )),
            NodeWeak::Import(node) => Ok(Self::Import(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Import))?,
            )),
            NodeWeak::Cast(node) => Ok(Self::Cast(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Cast))?,
            )),
            NodeWeak::Available(node) => Ok(Self::Available(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Available))?,
            )),
            NodeWeak::SpecifyOrder(node) => Ok(Self::SpecifyOrder(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::SpecifyOrder))?,
            )),
            NodeWeak::ExplicitError(node) => Ok(Self::ExplicitError(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ExplicitError))?,
            )),
            NodeWeak::IoOperation(node) => Ok(Self::IoOperation(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IoOperation))?,
            )),
            NodeWeak::OrCond(node) => Ok(Self::OrCond(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::OrCond))?,
            )),
            NodeWeak::BadExpr(node) => Ok(Self::BadExpr(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::BadExpr))?,
            )),
            NodeWeak::Loop(node) => Ok(Self::Loop(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Loop))?,
            )),
            NodeWeak::IndentBlock(node) => Ok(Self::IndentBlock(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IndentBlock))?,
            )),
            NodeWeak::ScopedStatement(node) => Ok(Self::ScopedStatement(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ScopedStatement))?,
            )),
            NodeWeak::MatchBranch(node) => Ok(Self::MatchBranch(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::MatchBranch))?,
            )),
            NodeWeak::UnionCandidate(node) => Ok(Self::UnionCandidate(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::UnionCandidate))?,
            )),
            NodeWeak::Return(node) => Ok(Self::Return(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Return))?,
            )),
            NodeWeak::Break(node) => Ok(Self::Break(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Break))?,
            )),
            NodeWeak::Continue(node) => Ok(Self::Continue(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Continue))?,
            )),
            NodeWeak::Assert(node) => Ok(Self::Assert(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Assert))?,
            )),
            NodeWeak::ImplicitYield(node) => Ok(Self::ImplicitYield(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ImplicitYield))?,
            )),
            NodeWeak::Metadata(node) => Ok(Self::Metadata(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Metadata))?,
            )),
            NodeWeak::IntType(node) => Ok(Self::IntType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IntType))?,
            )),
            NodeWeak::FloatType(node) => Ok(Self::FloatType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::FloatType))?,
            )),
            NodeWeak::IdentType(node) => Ok(Self::IdentType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IdentType))?,
            )),
            NodeWeak::IntLiteralType(node) => Ok(Self::IntLiteralType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IntLiteralType))?,
            )),
            NodeWeak::StrLiteralType(node) => Ok(Self::StrLiteralType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StrLiteralType))?,
            )),
            NodeWeak::RegexLiteralType(node) => Ok(Self::RegexLiteralType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::RegexLiteralType))?,
            )),
            NodeWeak::VoidType(node) => Ok(Self::VoidType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::VoidType))?,
            )),
            NodeWeak::BoolType(node) => Ok(Self::BoolType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::BoolType))?,
            )),
            NodeWeak::ArrayType(node) => Ok(Self::ArrayType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ArrayType))?,
            )),
            NodeWeak::FunctionType(node) => Ok(Self::FunctionType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::FunctionType))?,
            )),
            NodeWeak::StructType(node) => Ok(Self::StructType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StructType))?,
            )),
            NodeWeak::StructUnionType(node) => Ok(Self::StructUnionType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StructUnionType))?,
            )),
            NodeWeak::UnionType(node) => Ok(Self::UnionType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::UnionType))?,
            )),
            NodeWeak::RangeType(node) => Ok(Self::RangeType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::RangeType))?,
            )),
            NodeWeak::EnumType(node) => Ok(Self::EnumType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::EnumType))?,
            )),
            NodeWeak::MetaType(node) => Ok(Self::MetaType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::MetaType))?,
            )),
            NodeWeak::OptionalType(node) => Ok(Self::OptionalType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::OptionalType))?,
            )),
            NodeWeak::GenericType(node) => Ok(Self::GenericType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::GenericType))?,
            )),
            NodeWeak::IntLiteral(node) => Ok(Self::IntLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IntLiteral))?,
            )),
            NodeWeak::BoolLiteral(node) => Ok(Self::BoolLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::BoolLiteral))?,
            )),
            NodeWeak::StrLiteral(node) => Ok(Self::StrLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StrLiteral))?,
            )),
            NodeWeak::RegexLiteral(node) => Ok(Self::RegexLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::RegexLiteral))?,
            )),
            NodeWeak::CharLiteral(node) => Ok(Self::CharLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::CharLiteral))?,
            )),
            NodeWeak::TypeLiteral(node) => Ok(Self::TypeLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::TypeLiteral))?,
            )),
            NodeWeak::SpecialLiteral(node) => Ok(Self::SpecialLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::SpecialLiteral))?,
            )),
            NodeWeak::Field(node) => Ok(Self::Field(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Field))?,
            )),
            NodeWeak::Format(node) => Ok(Self::Format(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Format))?,
            )),
            NodeWeak::State(node) => Ok(Self::State(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::State))?,
            )),
            NodeWeak::Enum(node) => Ok(Self::Enum(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Enum))?,
            )),
            NodeWeak::EnumMember(node) => Ok(Self::EnumMember(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::EnumMember))?,
            )),
            NodeWeak::Function(node) => Ok(Self::Function(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Function))?,
            )),
        }
    }
}
...
impl TryFrom<&ExprWeak> for Expr {
    ...
    fn try_from(node: &ExprWeak) -> Result<Self, Self::Error> {
        match node {
            ExprWeak::Binary(node) => Ok(Self::Binary(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Binary))?,
            )),
            ExprWeak::Unary(node) => Ok(Self::Unary(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Unary))?,
            )),
            ExprWeak::Cond(node) => Ok(Self::Cond(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Cond))?,
            )),
            ExprWeak::Ident(node) => Ok(Self::Ident(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Ident))?,
            )),
            ExprWeak::Call(node) => Ok(Self::Call(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Call))?,
            )),
            ExprWeak::If(node) => Ok(Self::If(
                node.upgrade().ok_or(Error::InvalidNodeType(NodeType::If))?,
            )),
            ExprWeak::MemberAccess(node) => Ok(Self::MemberAccess(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::MemberAccess))?,
            )),
            ExprWeak::Paren(node) => Ok(Self::Paren(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Paren))?,
            )),
            ExprWeak::Index(node) => Ok(Self::Index(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Index))?,
            )),
            ExprWeak::Match(node) => Ok(Self::Match(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Match))?,
            )),
            ExprWeak::Range(node) => Ok(Self::Range(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Range))?,
            )),
            ExprWeak::Identity(node) => Ok(Self::Identity(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Identity))?,
            )),
            ExprWeak::TmpVar(node) => Ok(Self::TmpVar(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::TmpVar))?,
            )),
            ExprWeak::Import(node) => Ok(Self::Import(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Import))?,
            )),
            ExprWeak::Cast(node) => Ok(Self::Cast(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Cast))?,
            )),
            ExprWeak::Available(node) => Ok(Self::Available(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Available))?,
            )),
            ExprWeak::SpecifyOrder(node) => Ok(Self::SpecifyOrder(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::SpecifyOrder))?,
            )),
            ExprWeak::ExplicitError(node) => Ok(Self::ExplicitError(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ExplicitError))?,
            )),
            ExprWeak::IoOperation(node) => Ok(Self::IoOperation(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IoOperation))?,
            )),
            ExprWeak::OrCond(node) => Ok(Self::OrCond(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::OrCond))?,
            )),
            ExprWeak::BadExpr(node) => Ok(Self::BadExpr(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::BadExpr))?,
            )),
            ExprWeak::IntLiteral(node) => Ok(Self::IntLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IntLiteral))?,
            )),
            ExprWeak::BoolLiteral(node) => Ok(Self::BoolLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::BoolLiteral))?,
            )),
            ExprWeak::StrLiteral(node) => Ok(Self::StrLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StrLiteral))?,
            )),
            ExprWeak::RegexLiteral(node) => Ok(Self::RegexLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::RegexLiteral))?,
            )),
            ExprWeak::CharLiteral(node) => Ok(Self::CharLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::CharLiteral))?,
            )),
            ExprWeak::TypeLiteral(node) => Ok(Self::TypeLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::TypeLiteral))?,
            )),
            ExprWeak::SpecialLiteral(node) => Ok(Self::SpecialLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::SpecialLiteral))?,
            )),
        }
...
impl TryFrom<&StmtWeak> for Stmt {
    ...
    fn try_from(node: &StmtWeak) -> Result<Self, Self::Error> {
        match node {
            StmtWeak::Loop(node) => Ok(Self::Loop(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Loop))?,
            )),
            StmtWeak::IndentBlock(node) => Ok(Self::IndentBlock(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IndentBlock))?,
            )),
            StmtWeak::ScopedStatement(node) => Ok(Self::ScopedStatement(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ScopedStatement))?,
            )),
            StmtWeak::MatchBranch(node) => Ok(Self::MatchBranch(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::MatchBranch))?,
            )),
            StmtWeak::UnionCandidate(node) => Ok(Self::UnionCandidate(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::UnionCandidate))?,
            )),
            StmtWeak::Return(node) => Ok(Self::Return(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Return))?,
            )),
            StmtWeak::Break(node) => Ok(Self::Break(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Break))?,
            )),
            StmtWeak::Continue(node) => Ok(Self::Continue(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Continue))?,
            )),
            StmtWeak::Assert(node) => Ok(Self::Assert(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Assert))?,
            )),
            StmtWeak::ImplicitYield(node) => Ok(Self::ImplicitYield(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ImplicitYield))?,
            )),
            StmtWeak::Metadata(node) => Ok(Self::Metadata(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Metadata))?,
            )),
            StmtWeak::Field(node) => Ok(Self::Field(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Field))?,
            )),
            StmtWeak::Format(node) => Ok(Self::Format(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Format))?,
            )),
            StmtWeak::State(node) => Ok(Self::State(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::State))?,
            )),
            StmtWeak::Enum(node) => Ok(Self::Enum(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Enum))?,
            )),
            StmtWeak::EnumMember(node) => Ok(Self::EnumMember(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::EnumMember))?,
            )),
            StmtWeak::Function(node) => Ok(Self::Function(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Function))?,
            )),
        }
...
impl TryFrom<&TypeWeak> for Type {
    ...
    fn try_from(node: &TypeWeak) -> Result<Self, Self::Error> {
        match node {
            TypeWeak::IntType(node) => Ok(Self::IntType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IntType))?,
            )),
            TypeWeak::FloatType(node) => Ok(Self::FloatType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::FloatType))?,
            )),
            TypeWeak::IdentType(node) => Ok(Self::IdentType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IdentType))?,
            )),
            TypeWeak::IntLiteralType(node) => Ok(Self::IntLiteralType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IntLiteralType))?,
            )),
            TypeWeak::StrLiteralType(node) => Ok(Self::StrLiteralType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StrLiteralType))?,
            )),
            TypeWeak::RegexLiteralType(node) => Ok(Self::RegexLiteralType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::RegexLiteralType))?,
            )),
            TypeWeak::VoidType(node) => Ok(Self::VoidType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::VoidType))?,
            )),
            TypeWeak::BoolType(node) => Ok(Self::BoolType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::BoolType))?,
            )),
            TypeWeak::ArrayType(node) => Ok(Self::ArrayType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::ArrayType))?,
            )),
            TypeWeak::FunctionType(node) => Ok(Self::FunctionType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::FunctionType))?,
            )),
            TypeWeak::StructType(node) => Ok(Self::StructType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StructType))?,
            )),
            TypeWeak::StructUnionType(node) => Ok(Self::StructUnionType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StructUnionType))?,
            )),
            TypeWeak::UnionType(node) => Ok(Self::UnionType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::UnionType))?,
            )),
            TypeWeak::RangeType(node) => Ok(Self::RangeType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::RangeType))?,
            )),
            TypeWeak::EnumType(node) => Ok(Self::EnumType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::EnumType))?,
            )),
            TypeWeak::MetaType(node) => Ok(Self::MetaType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::MetaType))?,
            )),
            TypeWeak::OptionalType(node) => Ok(Self::OptionalType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::OptionalType))?,
            )),
            TypeWeak::GenericType(node) => Ok(Self::GenericType(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::GenericType))?,
            )),
        }
...
impl TryFrom<&LiteralWeak> for Literal {
    ...
    fn try_from(node: &LiteralWeak) -> Result<Self, Self::Error> {
        match node {
            LiteralWeak::IntLiteral(node) => Ok(Self::IntLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::IntLiteral))?,
            )),
            LiteralWeak::BoolLiteral(node) => Ok(Self::BoolLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::BoolLiteral))?,
            )),
            LiteralWeak::StrLiteral(node) => Ok(Self::StrLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::StrLiteral))?,
            )),
            LiteralWeak::RegexLiteral(node) => Ok(Self::RegexLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::RegexLiteral))?,
            )),
            LiteralWeak::CharLiteral(node) => Ok(Self::CharLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::CharLiteral))?,
            )),
            LiteralWeak::TypeLiteral(node) => Ok(Self::TypeLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::TypeLiteral))?,
            )),
            LiteralWeak::SpecialLiteral(node) => Ok(Self::SpecialLiteral(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::SpecialLiteral))?,
            )),
        }
...
impl TryFrom<&MemberWeak> for Member {
    ...
    fn try_from(node: &MemberWeak) -> Result<Self, Self::Error> {
        match node {
            MemberWeak::Field(node) => Ok(Self::Field(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Field))?,
            )),
            MemberWeak::Format(node) => Ok(Self::Format(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Format))?,
            )),
            MemberWeak::State(node) => Ok(Self::State(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::State))?,
            )),
            MemberWeak::Enum(node) => Ok(Self::Enum(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Enum))?,
            )),
            MemberWeak::EnumMember(node) => Ok(Self::EnumMember(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::EnumMember))?,
            )),
            MemberWeak::Function(node) => Ok(Self::Function(
                node.upgrade()
                    .ok_or(Error::InvalidNodeType(NodeType::Function))?,
            )),
        }
...
impl TryFrom<&Literal> for Rc<RefCell<CharLiteral>> {
    ...
    fn try_from(node: &Literal) -> Result<Self, Self::Error> {
        match node {
            Literal::CharLiteral(node) => Ok(node.clone()),
            _ => Err(Error::InvalidNodeType(Node::from(node).into())),
        }
    }
}
...
impl From<&Rc<RefCell<CharLiteral>>> for Literal {
    fn from(node: &Rc<RefCell<CharLiteral>>) -> Self {
        Literal::CharLiteral(node.clone())
    }
}
...
impl TryFrom<&Expr> for Rc<RefCell<CharLiteral>> {
    type Error = Error;
    fn try_from(node: &Expr) -> Result<Self, Self::Error> {
        match node {
            Expr::CharLiteral(node) => Ok(node.clone()),
            _ => Err(Error::InvalidNodeType(Node::from(node).into())),
        }
    }
}
...
impl From<&Rc<RefCell<CharLiteral>>> for Expr {
    fn from(node: &Rc<RefCell<CharLiteral>>) -> Self {
        Expr::CharLiteral(node.clone())
    }
}
...
impl TryFrom<&Node> for Rc<RefCell<CharLiteral>> {
    type Error = Error;
    fn try_from(node: &Node) -> Result<Self, Self::Error> {
        match node {
            Node::CharLiteral(node) => Ok(node.clone()),
            _ => Err(Error::InvalidNodeType(node.into())),
        }
    }
}
...
impl From<&Rc<RefCell<CharLiteral>>> for Node {
    fn from(node: &Rc<RefCell<CharLiteral>>) -> Self {
...
pub fn parse_ast(ast: JsonAst) -> Result<Rc<RefCell<Program>>, Error> {
    ...
    for raw_node in &ast.node {
        ...
        let node = match node_type {
            NodeType::Program => Node::Program(Rc::new(RefCell::new(Program {
            ...
            NodeType::Comment => Node::Comment(Rc::new(RefCell::new(Comment {
                loc: raw_node.loc.clone(),
                comment: String::new(),
            }))),
            NodeType::CommentGroup => Node::CommentGroup(Rc::new(RefCell::new(CommentGroup {
                loc: raw_node.loc.clone(),
                comments: Vec::new(),
            }))),
            NodeType::FieldArgument => Node::FieldArgument(Rc::new(RefCell::new(FieldArgument {
                loc: raw_node.loc.clone(),
                raw_arguments: None,
            ...
            NodeType::Binary => Node::Binary(Rc::new(RefCell::new(Binary {
                loc: raw_node.loc.clone(),
                expr_type: None,
            ...
            NodeType::Unary => Node::Unary(Rc::new(RefCell::new(Unary {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                op: UnaryOp::Not,
            ...
            NodeType::Cond => Node::Cond(Rc::new(RefCell::new(Cond {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                cond: None,
            ...
            NodeType::Ident => Node::Ident(Rc::new(RefCell::new(Ident {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                ident: String::new(),
            ...
            NodeType::Call => Node::Call(Rc::new(RefCell::new(Call {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                callee: None,
            ...
            NodeType::If => Node::If(Rc::new(RefCell::new(If {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
            ...
            NodeType::MemberAccess => Node::MemberAccess(Rc::new(RefCell::new(MemberAccess {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                target: None,
            ...
            NodeType::Paren => Node::Paren(Rc::new(RefCell::new(Paren {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                expr: None,
            ...
            NodeType::Index => Node::Index(Rc::new(RefCell::new(Index {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                expr: None,
            ...
            NodeType::Match => Node::Match(Rc::new(RefCell::new(Match {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                struct_union_type: None,
            ...
            NodeType::Range => Node::Range(Rc::new(RefCell::new(Range {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                op: BinaryOp::Mul,
            ...
            NodeType::Identity => Node::Identity(Rc::new(RefCell::new(Identity {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                expr: None,
            }))),
            NodeType::TmpVar => Node::TmpVar(Rc::new(RefCell::new(TmpVar {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                tmp_var: 0,
            }))),
            NodeType::Import => Node::Import(Rc::new(RefCell::new(Import {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                path: String::new(),
            ...
            NodeType::Cast => Node::Cast(Rc::new(RefCell::new(Cast {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                base: None,
            ...
            NodeType::Available => Node::Available(Rc::new(RefCell::new(Available {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                base: None,
            ...
            NodeType::SpecifyOrder => Node::SpecifyOrder(Rc::new(RefCell::new(SpecifyOrder {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                base: None,
            ...
            NodeType::ExplicitError => Node::ExplicitError(Rc::new(RefCell::new(ExplicitError {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                base: None,
            ...
            NodeType::IoOperation => Node::IoOperation(Rc::new(RefCell::new(IoOperation {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                base: None,
            ...
            NodeType::OrCond => Node::OrCond(Rc::new(RefCell::new(OrCond {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                base: None,
            ...
            NodeType::BadExpr => Node::BadExpr(Rc::new(RefCell::new(BadExpr {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                content: String::new(),
            ...
            NodeType::Loop => Node::Loop(Rc::new(RefCell::new(Loop {
                loc: raw_node.loc.clone(),
                cond_scope: None,
                init: None,
                cond: None,
            ...
            NodeType::IndentBlock => Node::IndentBlock(Rc::new(RefCell::new(IndentBlock {
                loc: raw_node.loc.clone(),
                struct_type: None,
                elements: Vec::new(),
                scope: None,
            ...
            NodeType::MatchBranch => Node::MatchBranch(Rc::new(RefCell::new(MatchBranch {
                loc: raw_node.loc.clone(),
                belong: None,
                cond: None,
            ...
            NodeType::Return => Node::Return(Rc::new(RefCell::new(Return {
                loc: raw_node.loc.clone(),
                expr: None,
                related_function: None,
            }))),
            NodeType::Break => Node::Break(Rc::new(RefCell::new(Break {
                loc: raw_node.loc.clone(),
                related_loop: None,
            }))),
            NodeType::Continue => Node::Continue(Rc::new(RefCell::new(Continue {
                loc: raw_node.loc.clone(),
                related_loop: None,
            }))),
            NodeType::Assert => Node::Assert(Rc::new(RefCell::new(Assert {
                loc: raw_node.loc.clone(),
                cond: None,
                is_io_related: false,
            }))),
            NodeType::ImplicitYield => Node::ImplicitYield(Rc::new(RefCell::new(ImplicitYield {
                loc: raw_node.loc.clone(),
                expr: None,
            }))),
            NodeType::Metadata => Node::Metadata(Rc::new(RefCell::new(Metadata {
                loc: raw_node.loc.clone(),
                base: None,
                name: String::new(),
                values: Vec::new(),
            }))),
            NodeType::IntType => Node::IntType(Rc::new(RefCell::new(IntType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
            ...
            NodeType::FloatType => Node::FloatType(Rc::new(RefCell::new(FloatType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::IdentType => Node::IdentType(Rc::new(RefCell::new(IdentType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::VoidType => Node::VoidType(Rc::new(RefCell::new(VoidType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::BoolType => Node::BoolType(Rc::new(RefCell::new(BoolType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::ArrayType => Node::ArrayType(Rc::new(RefCell::new(ArrayType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::FunctionType => Node::FunctionType(Rc::new(RefCell::new(FunctionType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::StructType => Node::StructType(Rc::new(RefCell::new(StructType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::UnionType => Node::UnionType(Rc::new(RefCell::new(UnionType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::RangeType => Node::RangeType(Rc::new(RefCell::new(RangeType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::EnumType => Node::EnumType(Rc::new(RefCell::new(EnumType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::MetaType => Node::MetaType(Rc::new(RefCell::new(MetaType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::OptionalType => Node::OptionalType(Rc::new(RefCell::new(OptionalType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::GenericType => Node::GenericType(Rc::new(RefCell::new(GenericType {
                loc: raw_node.loc.clone(),
                is_explicit: false,
                non_dynamic_allocation: false,
                bit_alignment: BitAlignment::ByteAligned,
            ...
            NodeType::IntLiteral => Node::IntLiteral(Rc::new(RefCell::new(IntLiteral {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                value: String::new(),
            }))),
            NodeType::BoolLiteral => Node::BoolLiteral(Rc::new(RefCell::new(BoolLiteral {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                value: false,
            }))),
            NodeType::StrLiteral => Node::StrLiteral(Rc::new(RefCell::new(StrLiteral {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                value: String::new(),
            ...
            NodeType::RegexLiteral => Node::RegexLiteral(Rc::new(RefCell::new(RegexLiteral {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                value: String::new(),
            }))),
            NodeType::CharLiteral => Node::CharLiteral(Rc::new(RefCell::new(CharLiteral {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                value: String::new(),
            ...
            NodeType::TypeLiteral => Node::TypeLiteral(Rc::new(RefCell::new(TypeLiteral {
                loc: raw_node.loc.clone(),
                expr_type: None,
                constant_level: ConstantLevel::Unknown,
                type_literal: None,
            ...
            NodeType::Field => Node::Field(Rc::new(RefCell::new(Field {
                loc: raw_node.loc.clone(),
                belong: None,
                belong_struct: None,
                ident: None,
            ...
            NodeType::Format => Node::Format(Rc::new(RefCell::new(Format {
                loc: raw_node.loc.clone(),
                belong: None,
                belong_struct: None,
                ident: None,
            ...
            NodeType::State => Node::State(Rc::new(RefCell::new(State {
                loc: raw_node.loc.clone(),
                belong: None,
                belong_struct: None,
                ident: None,
            ...
            NodeType::Enum => Node::Enum(Rc::new(RefCell::new(Enum {
                loc: raw_node.loc.clone(),
                belong: None,
                belong_struct: None,
                ident: None,
            ...
            NodeType::EnumMember => Node::EnumMember(Rc::new(RefCell::new(EnumMember {
                loc: raw_node.loc.clone(),
                belong: None,
                belong_struct: None,
                ident: None,
            ...
            NodeType::Function => Node::Function(Rc::new(RefCell::new(Function {
                loc: raw_node.loc.clone(),
                belong: None,
                belong_struct: None,
                ident: None,
        ...
        match node_type {
            NodeType::Program => {
                ...
                if !struct_type_body.is_null() {
                    let struct_type_body = match struct_type_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(
                                struct_type_body.into(),
                                JSONType::Number,
                            ))
                        }
                    };
                    ...
                    let struct_type_body = match struct_type_body {
                        ...
                        x => {
                            return Err(Error::MismatchNodeType(x.into(), struct_type_body.into()))
                        }
                    };
                ...
                for link in metadata_body {
                    ...
                    node.borrow_mut()
                        .metadata
                        .push(Rc::downgrade(&metadata_body));
                }
            }
            NodeType::Comment => {
                let node = nodes[i].clone();
            ...
            NodeType::FieldArgument => {
                ...
                for link in collected_arguments_body {
                    ...
                    node.borrow_mut()
                        .collected_arguments
                        .push(collected_arguments_body.try_into()?);
                }
                ...
                if !peek_body.is_null() {
                    let peek_body = match peek_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(peek_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::Binary => {
                ...
                if !left_body.is_null() {
                    let left_body = match left_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(left_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::Unary => {
                ...
                if !expr_body.is_null() {
                    let expr_body = match expr_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(expr_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::Cond => {
                ...
                if !cond_body.is_null() {
                    let cond_body = match cond_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(cond_body.into(), JSONType::Number))
                        }
                    };
                ...
                if !then_body.is_null() {
                    let then_body = match then_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(then_body.into(), JSONType::Number))
                        }
                    };
                ...
                if !els_body.is_null() {
                    let els_body = match els_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(els_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::Ident => {
                ...
                node.borrow_mut().ident = match ident_body.as_str() {
                    Some(v) => v.to_string(),
                    None => {
                        return Err(Error::MismatchJSONType(ident_body.into(), JSONType::String))
                    }
                };
                ...
                node.borrow_mut().usage = match usage_body.as_str() {
                    ...
                    None => {
                        return Err(Error::MismatchJSONType(usage_body.into(), JSONType::String))
                    }
                };
                ...
                if !base_body.is_null() {
                    let base_body = match base_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(base_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::If => {
                ...
                if !struct_union_type_body.is_null() {
                    ...
                    let struct_union_type_body = match nodes.get(struct_union_type_body as usize) {
                        Some(v) => v,
                        None => {
                            return Err(Error::IndexOutOfBounds(struct_union_type_body as usize))
                        }
                    };
                    let struct_union_type_body = match struct_union_type_body {
                        Node::StructUnionType(node) => node,
                        x => {
                            return Err(Error::MismatchNodeType(
                                x.into(),
                                struct_union_type_body.into(),
                            ))
                        }
            ...
            NodeType::Match => {
                ...
                let branch_body = match branch_body.as_array() {
                    Some(v) => v,
                    None => {
                        return Err(Error::MismatchJSONType(branch_body.into(), JSONType::Array))
                    }
                };
            ...
            NodeType::Range => {
                ...
                if !end_body.is_null() {
                    let end_body = match end_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(end_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::Import => {
                ...
                node.borrow_mut().path = match path_body.as_str() {
                    Some(v) => v.to_string(),
                    None => {
                        return Err(Error::MismatchJSONType(path_body.into(), JSONType::String))
                    }
                };
                let base_body = match raw_node.body.get("base") {
                    Some(v) => v,
                ...
                if !import_desc_body.is_null() {
                    ...
                    let import_desc_body = match import_desc_body {
                        Node::Program(node) => node,
                        x => {
                            return Err(Error::MismatchNodeType(x.into(), import_desc_body.into()))
                        }
                    };
            ...
            NodeType::OrCond => {
                ...
                let conds_body = match conds_body.as_array() {
                    Some(v) => v,
                    None => {
                        return Err(Error::MismatchJSONType(conds_body.into(), JSONType::Array))
                    }
                };
            ...
            NodeType::Loop => {
                ...
                if !init_body.is_null() {
                    let init_body = match init_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(init_body.into(), JSONType::Number))
                        }
                    };
                ...
                if !step_body.is_null() {
                    let step_body = match step_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(step_body.into(), JSONType::Number))
                        }
                    };
                ...
                if !body_body.is_null() {
                    let body_body = match body_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(body_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::Return => {
                ...
                if !related_function_body.is_null() {
                    ...
                    let related_function_body = match nodes.get(related_function_body as usize) {
                        Some(v) => v,
                        None => {
                            return Err(Error::IndexOutOfBounds(related_function_body as usize))
                        }
                    };
                    ...
                    node.borrow_mut().related_function =
                        Some(Rc::downgrade(&related_function_body));
                }
            }
            NodeType::Break => {
                let node = nodes[i].clone();
                ...
                if !related_loop_body.is_null() {
                    ...
                    let related_loop_body = match related_loop_body {
                        Node::Loop(node) => node,
                        x => {
                            return Err(Error::MismatchNodeType(x.into(), related_loop_body.into()))
                        }
                    };
            ...
            NodeType::Metadata => {
                ...
                node.borrow_mut().name = match name_body.as_str() {
                    Some(v) => v.to_string(),
                    None => {
                        return Err(Error::MismatchJSONType(name_body.into(), JSONType::String))
                    }
                };
                ...
                let values_body = match values_body.as_array() {
                    Some(v) => v,
                    None => {
                        return Err(Error::MismatchJSONType(values_body.into(), JSONType::Array))
                    }
                };
            ...
            NodeType::IntType => {
                ...
                node.borrow_mut().non_dynamic_allocation =
                    match non_dynamic_allocation_body.as_bool() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(
                                non_dynamic_allocation_body.into(),
                                JSONType::Bool,
                            ))
                        }
                    };
            ...
            NodeType::StructType => {
                ...
                let fields_body = match fields_body.as_array() {
                    Some(v) => v,
                    None => {
                        return Err(Error::MismatchJSONType(fields_body.into(), JSONType::Array))
                    }
                };
            ...
            NodeType::StructUnionType => {
                ...
                for link in union_fields_body {
                    ...
                    let union_fields_body = match union_fields_body {
                        ...
                        x => {
                            return Err(Error::MismatchNodeType(x.into(), union_fields_body.into()))
                        }
                    };
                    node.borrow_mut()
                        .union_fields
                        .push(Rc::downgrade(&union_fields_body));
                }
            ...
            NodeType::UnionType => {
                ...
                for link in member_candidates_body {
                    ...
                    node.borrow_mut()
                        .member_candidates
                        .push(member_candidates_body.clone());
                }
            }
            NodeType::RangeType => {
                let node = nodes[i].clone();
            ...
            NodeType::IntLiteral => {
                ...
                node.borrow_mut().value = match value_body.as_str() {
                    Some(v) => v.to_string(),
                    None => {
                        return Err(Error::MismatchJSONType(value_body.into(), JSONType::String))
                    }
                };
            }
            NodeType::BoolLiteral => {
            ...
            NodeType::CharLiteral => {
                ...
                let code_body = match raw_node.body.get("code") {
                    Some(v) => v,
                    None => return Err(Error::MissingField(node_type, "code")),
                };
                node.borrow_mut().code = match code_body.as_u64() {
                    Some(v) => v,
                    None => {
                        return Err(Error::MismatchJSONType(code_body.into(), JSONType::Number))
                    }
                };
            }
            NodeType::TypeLiteral => {
            ...
            NodeType::SpecialLiteral => {
                ...
                node.borrow_mut().kind = match kind_body.as_str() {
                    ...
                    None => {
                        return Err(Error::MismatchJSONType(kind_body.into(), JSONType::String))
                    }
                };
            }
            NodeType::Field => {
                ...
                node.borrow_mut().eventual_bit_alignment =
                    match eventual_bit_alignment_body.as_str() {
                        Some(v) => match BitAlignment::try_from(v) {
                            Ok(v) => v,
                            Err(_) => return Err(Error::InvalidEnumValue(v.to_string())),
                        },
                        None => {
                            return Err(Error::MismatchJSONType(
                                eventual_bit_alignment_body.into(),
                                JSONType::String,
                            ))
                        }
                    };
                ...
                if !next_body.is_null() {
                    let next_body = match next_body.as_u64() {
                        Some(v) => v,
                        None => {
                            return Err(Error::MismatchJSONType(next_body.into(), JSONType::Number))
                        }
                    };
            ...
            NodeType::Format => {
                ...
                for link in cast_fns_body {
                    ...
                    node.borrow_mut()
                        .cast_fns
                        .push(Rc::downgrade(&cast_fns_body));
                }
                ...
                for link in state_variables_body {
                    ...
                    node.borrow_mut()
                        .state_variables
                        .push(Rc::downgrade(&state_variables_body));
                }
            }
            NodeType::State => {
                let node = nodes[i].clone();
            ...
            NodeType::EnumMember => {
                ...
                if !str_literal_body.is_null() {
                    ...
                    let str_literal_body = match str_literal_body {
                        Node::StrLiteral(node) => node,
                        x => {
                            return Err(Error::MismatchNodeType(x.into(), str_literal_body.into()))
                        }
                    };
            ...
            NodeType::Function => {
                ...
                node.borrow_mut().is_cast = match is_cast_body.as_bool() {
                    Some(v) => v,
                    None => {
                        return Err(Error::MismatchJSONType(is_cast_body.into(), JSONType::Bool))
                    }
                };
            }
            _ => return Err(Error::UnknownNodeType(node_type)),

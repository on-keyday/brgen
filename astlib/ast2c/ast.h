...
typedef struct ast2c_Sizeof ast2c_Sizeof;
...
enum ast2c_NodeType {
	...
	AST2C_NODETYPE_SIZEOF_ = 65557,
	AST2C_NODETYPE_BAD_EXPR = 65558,
...
enum ast2c_IoMethod {
	...
	AST2C_IOMETHOD_INPUT_SCOPE_LENGTH = 9,
	AST2C_IOMETHOD_CONFIG_ENDIAN_LITTLE = 10,
	AST2C_IOMETHOD_CONFIG_ENDIAN_BIG = 11,
	AST2C_IOMETHOD_CONFIG_ENDIAN_NATIVE = 12,
	AST2C_IOMETHOD_CONFIG_BIT_ORDER_LSB = 13,
	AST2C_IOMETHOD_CONFIG_BIT_ORDER_MSB = 14,
};
...
// returns 1 if succeed 0 if failed
int ast2c_Sizeof_parse(ast2c_Ast* ,ast2c_Sizeof*,ast2c_json_handlers*,void*);

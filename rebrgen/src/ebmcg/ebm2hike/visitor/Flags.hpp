...
FILE_EXTENSIONS(".hike");
WEB_UI_NAME("hike");
DEFINE_STRING_FLAG(package_name, "", "package", "Package name for generated Hike code", "NAME");
DEFINE_BOOL_FLAG(no_prelude, false, "no-prelude", "Do not emit the ebmDecoder/ebmEncoder runtime prelude (supply your own)");
CONFIG_MAP("config.hike.package", package_name);

...
DEFINE_STRING_FLAG(class_name, "BgnGenerated", "class-name", "outer class name of the generated java file (must match the .java file name)", "NAME");
DEFINE_BOOL_FLAG(no_stream_io, false, "no-stream-io", "do not generate java.io.InputStream/OutputStream convenience overloads for encode/decode");

...
FILE_EXTENSIONS(".cs");
DEFINE_STRING_FLAG(class_name, "BgnGenerated", "class-name", "outer class name of the generated C# file", "NAME");
DEFINE_BOOL_FLAG(no_stream_io, false, "no-stream-io", "do not generate System.IO.Stream convenience overloads for encode/decode");

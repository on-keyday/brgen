...
namespace ebm {
    ...
    bool from_json(ExpressionBody& obj, const futils::json::JSON& j) {
        ...
        if (auto got = j.at("sizeof_desc")) {
            SizeofDesc tmp;
            if(!futils::json::convert_from_json(*got, tmp)) {
                return false;
            }
            if(!obj.sizeof_desc(std::move(tmp))) {
                return false;
            }
        }
    ...
    bool from_json(FieldDecl& obj, const futils::json::JSON& j) {
        ...
        if (auto got = j.at("has_range")) {
            bool tmp;
            if(!futils::json::convert_from_json(*got, tmp)) {
                return false;
            }
            obj.has_range(std::move(tmp));
        }
        else {
            return false;
        }
        ...
        if (auto got = j.at("range_statement")) {
            WeakStatementRef tmp;
            if(!futils::json::convert_from_json(*got, tmp)) {
                return false;
            }
            if(!obj.range_statement(std::move(tmp))) {
                return false;
            }
        }
        return true;
    ...
    bool from_json(FunctionAttribute& obj, const futils::json::JSON& j) {
        ...
        if (auto got = j.at("is_mutable")) {
            bool tmp;
            if(!futils::json::convert_from_json(*got, tmp)) {
                return false;
            }
            obj.is_mutable(std::move(tmp));
        }
        else {
            return false;
        }
    ...
    bool from_json(ParameterDecl& obj, const futils::json::JSON& j) {
        ...
        if (auto got = j.at("is_runtime_state")) {
            bool tmp;
            if(!futils::json::convert_from_json(*got, tmp)) {
                return false;
            }
            obj.is_runtime_state(std::move(tmp));
        }
        else {
            return false;
        }
    ...
    bool from_json(TypeBody& obj, const futils::json::JSON& j) {
        ...
        if (auto got = j.at("length_expr")) {
            ExpressionRef tmp;
            if(!futils::json::convert_from_json(*got, tmp)) {
                return false;
            }
            if(!obj.length_expr(std::move(tmp))) {
                return false;
            }
        }

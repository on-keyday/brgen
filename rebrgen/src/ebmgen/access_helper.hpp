...
namespace ebmcodegen {
    ...
    constexpr decltype(auto) get_field(auto&& in){
        ...
        else if constexpr (std::is_same_v<T, ebm::StructUnionMember>) {
            if constexpr (false) {}
            else if constexpr (FieldIndex == 210) {
                auto& ref = in.member_type;
                return ref;
            }
            else if constexpr (FieldIndex == 3) {
                auto& ref = in.condition;
        ...
        else if constexpr (std::is_same_v<T,ebm::StructUnionMember*> || std::is_same_v<T,const ebm::StructUnionMember*>) {
            if constexpr (false) {}
            else if constexpr (FieldIndex == 210) {
                if (!in) {
                    return decltype(std::addressof(in->member_type))();
                }
                return std::addressof(in->member_type);
            }
            else if constexpr (FieldIndex == 3) {
                if (!in) {
                    return decltype(std::addressof(in->condition))();
        ...
        else if constexpr (std::is_same_v<T, ebm::StructUnionMembers>) {
            if constexpr (false) {}
            else if constexpr (FieldIndex == 5) {
                auto& ref = in.len;
                return ref;
        ...
        else if constexpr (std::is_same_v<T,ebm::StructUnionMembers*> || std::is_same_v<T,const ebm::StructUnionMembers*>) {
            if constexpr (false) {}
            else if constexpr (FieldIndex == 5) {
                if (!in) {
                    return decltype(std::addressof(in->len))();
    ...
    template<>
    constexpr size_t get_type_index<ebm::StructUnionMember>() {
        return 56;
    }
    template<>
    ...
    template<>
    constexpr size_t get_type_index<ebm::StructUnionMembers>() {
        return 57;
    }
    template<>
    ...
    constexpr decltype(auto) type_from_index() {
        if constexpr (false) {}
            ...
            if constexpr (index.is_array) {
                if constexpr (index.is_ptr) {
                    return (std::vector<ebm::StructUnionMember>*)nullptr;
                }
                else {
                    return std::vector<ebm::StructUnionMember>{};
                }
            }
            else {
                if constexpr (index.is_ptr) {
                    return (ebm::StructUnionMember*)nullptr;
                }
                else {
                    return ebm::StructUnionMember{};
                }
            }
        }
            ...
            if constexpr (index.is_array) {
                if constexpr (index.is_ptr) {
                    return (std::vector<ebm::StructUnionMembers>*)nullptr;
                }
                else {
                    return std::vector<ebm::StructUnionMembers>{};
                }
            }
            else {
                if constexpr (index.is_ptr) {
                    return (ebm::StructUnionMembers*)nullptr;
                }
                else {
                    return ebm::StructUnionMembers{};
                }
            }
        }
    ...
    constexpr std::string_view field_name_from_index(size_t index) {
        ...
        case 130: return "backward";
        case 33: return "base";
        case 22: return "base_type";
        case 165: return "block";
        case 29: return "body";
        case 34: return "bool_value";
        case 35: return "bop";
        case 146: return "branches";
        case 166: return "break_";
        case 36: return "call_desc";
        case 7: return "callee";
        case 224: return "cast_function";
        case 223: return "cast_kind";
        ...
        case 169: return "endian_convert";
        case 41: return "endian_expr";
        case 170: return "endian_variable";
        case 24: return "enum_decl";
        case 171: return "enum_member_decl";
        case 172: return "error_report";
        case 116: return "expect_value";
        case 131: return "expected_length";
        case 173: return "expression";
        case 76: return "expressions";
        case 75: return "expressions_len";
        case 103: return "field";
        case 174: return "field_decl";
        case 80: return "field_type";
        case 9: return "fields";
        case 134: return "file_id";
        case 14: return "files";
        case 159: return "from";
        case 222: return "from_type";
        ...
        case 108: return "has_absolute_offset";
        case 109: return "has_bit_offset";
        case 198: return "has_encode_decode";
        case 199: return "has_functions";
        case 100: return "has_lowered_statement";
        case 84: return "has_metadata";
        case 202: return "has_nested_types";
        case 101: return "has_offset";
        case 201: return "has_parent";
        case 200: return "has_properties";
        case 197: return "has_related_variant";
        case 162: return "has_value";
        case 93: return "has_wrapper";
        case 158: return "hint";
        case 28: return "id";
        case 133: return "ident";
        case 68: return "identifiers";
        case 67: return "identifiers_len";
        case 176: return "if_statement";
        case 122: return "imm";
        case 177: return "import_decl";
        case 140: return "increment";
        case 42: return "index";
        case 141: return "init";
        case 178: return "init_check";
        case 114: return "init_check_type";
        case 226: return "initial_value";
        ...
        case 196: return "is_fixed_size";
        case 149: return "is_immediate";
        case 1: return "is_inout";
        case 99: return "is_peek";
        case 195: return "is_recursive";
        case 228: return "is_reference";
        case 107: return "is_seekable";
        case 82: return "is_state_variable";
        case 92: return "is_user_defined";
        case 142: return "item_var";
        case 11: return "kind";
        case 47: return "left";
        case 5: return "len";
        case 13: return "len_files";
        case 15: return "len_locs";
        case 193: return "length";
        case 179: return "length_check";
        case 132: return "length_check_type";
        case 135: return "line";
        case 16: return "locs";
        case 180: return "loop";
        case 138: return "loop_type";
        ...
        case 183: return "match_statement";
        case 66: return "max_id";
        case 49: return "member";
        case 123: return "member_id";
        case 210: return "member_type";
        case 23: return "members";
        case 152: return "merge_mode";
        case 27: return "message";
        case 88: return "metadata";
        case 206: return "methods";
        case 124: return "msg_id";
        case 21: return "name";
        case 208: return "nested_types";
        case 143: return "next_lowered_loop";
        case 50: return "num_bytes";
        case 106: return "offset";
        case 118: return "op";
        case 51: return "operand";
        case 52: return "or_cond";
        case 184: return "param_decl";
        ...
        case 163: return "ref";
        case 125: return "reg";
        case 188: return "related_field";
        case 117: return "related_function";
        case 137: return "related_statement";
        case 203: return "related_variant";
        case 189: return "reserve_data";
        case 2: return "reserved";
        case 126: return "ret_value";
        case 89: return "return_type";
        case 53: return "right";
        case 127: return "set_endian";
        case 153: return "setter_condition";
        case 155: return "setter_function";
        case 54: return "setter_status";
        case 98: return "sign";
        case 105: return "size";
        case 19: return "source";
        case 221: return "source_expr";
        case 55: return "start";
        case 74: return "statements";
        case 73: return "statements_len";
        case 128: return "str_id";
        ...
        case 115: return "target_field";
        case 59: return "target_stmt";
        case 60: return "then";
        case 110: return "then_block";
        case 160: return "to";
        case 30: return "type";
    ...
    constexpr std::string_view type_name_from_index(size_t index) {
        ...
        case 56: return "StructUnionMember";
        case 57: return "StructUnionMembers";
    ...
    constexpr size_t get_type_index(std::string_view type_name) {
        ...
        if (type_name == "StructUnionMember") {
            return 56;
        }
        if (type_name == "StructUnionMembers") {
            return 57;
        }
    ...
    constexpr TypeIndex get_type_index_from_field(size_t type_index,size_t field_index) {
        ...
        case 51: {
            ...
            if (field_index == get_field_index<51>("block")) {
                return {.index = 2, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("break_")) {
                return {.index = 31, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("composite_field_decl")) {
                return {.index = 4, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("continue_")) {
                return {.index = 31, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("endian_convert")) {
                return {.index = 7, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("endian_variable")) {
                return {.index = 8, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("enum_decl")) {
                return {.index = 9, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("enum_member_decl")) {
                return {.index = 10, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("error_report")) {
            ...
            if (field_index == get_field_index<51>("func_decl")) {
                return {.index = 19, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("if_statement")) {
                return {.index = 24, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("import_decl")) {
                return {.index = 25, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("init_check")) {
                return {.index = 26, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("length_check")) {
                return {.index = 29, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("loop")) {
                return {.index = 32, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("lowered_io_statements")) {
                return {.index = 35, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("match_branch")) {
                return {.index = 37, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("match_statement")) {
                return {.index = 38, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("metadata")) {
                return {.index = 39, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("param_decl")) {
                return {.index = 41, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("property_decl")) {
                return {.index = 42, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("property_member_decl")) {
                return {.index = 43, .is_array = false, .is_ptr = true};
            }
            if (field_index == get_field_index<51>("read_data")) {
            ...
            if (field_index == get_field_index<51>("struct_decl")) {
        ...
        case 54: {
            ...
            if (field_index == get_field_index<54>("properties")) {
                return {.index = 2, .is_array = false, .is_ptr = true};
            }
        ...
        case 55: {
            ...
            if (field_index == get_field_index<55>("condition")) {
                return {.index = 68, .is_array = false, .is_ptr = false};
            }
            return {.index = static_cast<size_t>(-1), .is_array = false, .is_ptr = false};
        }
        case 56: {
            if (field_index == get_field_index<56>("member_type")) {
                return {.index = 67, .is_array = false, .is_ptr = false};
            }
            if (field_index == get_field_index<56>("condition")) {
                return {.index = 68, .is_array = false, .is_ptr = false};
            }
            return {.index = static_cast<size_t>(-1), .is_array = false, .is_ptr = false};
        }
        ...
        case 61: {
            ...
            if (field_index == get_field_index<61>("cast_function")) {
                return {.index = 65, .is_array = false, .is_ptr = true};
            }
            return {.index = static_cast<size_t>(-1), .is_array = false, .is_ptr = false};
        }

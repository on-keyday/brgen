...
typedef enum ast2c_FormatType ast2c_FormatType;
...
enum ast2c_FormatType {
	AST2C_FORMATTYPE_NONE = 0,
	AST2C_FORMATTYPE_FIXED_PRIMITIVE = 1,
	AST2C_FORMATTYPE_FIXED_FLOAT = 2,
	AST2C_FORMATTYPE_FIXED_PRIMITIVE_ARRAY = 4,
	AST2C_FORMATTYPE_FIXED_FLOAT_ARRAY = 8,
	AST2C_FORMATTYPE_VARIABLE_PRIMITIVE_ARRAY = 16,
	AST2C_FORMATTYPE_VARIABLE_FLOAT_ARRAY = 32,
	AST2C_FORMATTYPE_VARIABLE_STRUCT_ARRAY = 64,
	AST2C_FORMATTYPE_FIXED_STRUCT_ARRAY = 128,
	AST2C_FORMATTYPE_STRUCT = 256,
	AST2C_FORMATTYPE_CONDITIONAL = 512,
	AST2C_FORMATTYPE_STATIC_PEEK = 1024,
	AST2C_FORMATTYPE_BIT_FIELD = 2048,
	AST2C_FORMATTYPE_READ_STATE = 4096,
	AST2C_FORMATTYPE_WRITE_STATE = 8192,
	AST2C_FORMATTYPE_TERMINAL_STRING = 16384,
	AST2C_FORMATTYPE_TERMINAL_END = 32768,
	AST2C_FORMATTYPE_TERMINAL_REGEX = 65536,
	AST2C_FORMATTYPE_TERMINAL_FN = 131072,
	AST2C_FORMATTYPE_BIT_STREAM = 262144,
	AST2C_FORMATTYPE_DYNAMIC_ENDIAN = 524288,
	AST2C_FORMATTYPE_DYNAMIC_BIT_ORDER = 1048576,
	AST2C_FORMATTYPE_FULL_INPUT = 2097152,
	AST2C_FORMATTYPE_BACKWARD_INPUT = 4194304,
	AST2C_FORMATTYPE_MAGIC_STRING = 8388608,
	AST2C_FORMATTYPE_MAGIC_NUMBER = 16777216,
	AST2C_FORMATTYPE_ASSERTION = 33554432,
	AST2C_FORMATTYPE_EXPLICIT_ERROR = 67108864,
	AST2C_FORMATTYPE_PROCEDURAL = 134217728,
	AST2C_FORMATTYPE_FOR_LOOP = 268435456,
	AST2C_FORMATTYPE_LOCAL_VARIABLE = 536870912,
};
const char* ast2c_FormatType_to_string(ast2c_FormatType);
int ast2c_FormatType_from_string(const char*,ast2c_FormatType*);

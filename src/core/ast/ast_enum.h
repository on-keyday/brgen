...
constexpr const char* to_string(Follow e) {
    ...
    case Follow::reference: return "reference";
    case Follow::define_variable: return "define_variable";
    case Follow::define_const: return "define_const";
    case Follow::define_field: return "define_field";
    case Follow::define_format: return "define_format";
    case Follow::define_state: return "define_state";
    case Follow::define_enum: return "define_enum";
    case Follow::define_enum_member: return "define_enum_member";
    case Follow::define_fn: return "define_fn";
    case Follow::define_cast_fn: return "define_cast_fn";
    case Follow::define_arg: return "define_arg";
    case Follow::reference_type: return "reference_type";
    case Follow::reference_member: return "reference_member";
    case Follow::maybe_type: return "maybe_type";
    case Follow::reference_builtin_fn: return "reference_builtin_fn";
...
template<>constexpr std::array<std::pair<Follow,std::string_view>,16> make_enum_array<Follow>() {
    return {
...
template<>constexpr std::array<std::pair<Follow,std::string_view>,16> make_enum_name_array<Follow>() {
    return {
        std::pair{Follow::unknown,"unknown"},
        std::pair{Follow::reference,"reference"},
        std::pair{Follow::define_variable,"define_variable"},

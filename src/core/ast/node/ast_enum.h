...
namespace brgen::ast {
    ...
    template <>
    constexpr std::array<std::pair<Follow, std::string_view>, 5> make_enum_array<Follow>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<Follow, std::string_view>, 5> make_enum_name_array<Follow>() {
        return {
            std::pair{Follow::unknown, "unknown"},
            std::pair{Follow::end, "end"},
            std::pair{Follow::fixed, "fixed"},
    ...
    template <>
    constexpr std::array<std::pair<BinaryOp, std::string_view>, 38> make_enum_array<BinaryOp>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<BinaryOp, std::string_view>, 38> make_enum_name_array<BinaryOp>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<UnaryOp, std::string_view>, 2> make_enum_array<UnaryOp>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<UnaryOp, std::string_view>, 2> make_enum_name_array<UnaryOp>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<BitAlignment, std::string_view>, 10> make_enum_array<BitAlignment>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<BitAlignment, std::string_view>, 10> make_enum_name_array<BitAlignment>() {
        return {
            std::pair{BitAlignment::byte_aligned, "byte_aligned"},
            std::pair{BitAlignment::bit_1, "bit_1"},
            std::pair{BitAlignment::bit_2, "bit_2"},
    ...
    template <>
    constexpr std::array<std::pair<ConstantLevel, std::string_view>, 4> make_enum_array<ConstantLevel>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<ConstantLevel, std::string_view>, 4> make_enum_name_array<ConstantLevel>() {
        return {
            std::pair{ConstantLevel::unknown, "unknown"},
            std::pair{ConstantLevel::constant, "constant"},
            std::pair{ConstantLevel::const_variable, "const_variable"},
    ...
    template <>
    constexpr std::array<std::pair<IdentUsage, std::string_view>, 16> make_enum_array<IdentUsage>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<IdentUsage, std::string_view>, 16> make_enum_name_array<IdentUsage>() {
        return {
            std::pair{IdentUsage::unknown, "unknown"},
            std::pair{IdentUsage::reference, "reference"},
            std::pair{IdentUsage::define_variable, "define_variable"},
    ...
    template <>
    constexpr std::array<std::pair<Endian, std::string_view>, 3> make_enum_array<Endian>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<Endian, std::string_view>, 3> make_enum_name_array<Endian>() {
        return {
            std::pair{Endian::unspec, "unspec"},
            std::pair{Endian::big, "big"},
            std::pair{Endian::little, "little"},
    ...
    constexpr const char* to_string(IOMethod e) {
        switch (e) {
            case IOMethod::unspec:
                return "unspec";
            case IOMethod::output_put:
                return "output_put";
            case IOMethod::input_peek:
                return "input_peek";
            case IOMethod::input_get:
                return "input_get";
            case IOMethod::input_offset:
                return "input_offset";
            case IOMethod::input_remain:
                return "input_remain";
            case IOMethod::config_endian_little:
                return "config_endian_little";
            case IOMethod::config_endian_big:
                return "config_endian_big";
            case IOMethod::config_endian_native:
                return "config_endian_native";
            case IOMethod::input_backward:
    ...
    template <>
    constexpr std::optional<IOMethod> from_string<IOMethod>(std::string_view str) {
        if (str.empty()) return std::nullopt;
    ...
    template <>
    constexpr size_t enum_elem_count<IOMethod>() {
        return 10;
    }
    template <>
    constexpr std::array<std::pair<IOMethod, std::string_view>, 10> make_enum_array<IOMethod>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<IOMethod, std::string_view>, 10> make_enum_name_array<IOMethod>() {
        return {
            std::pair{IOMethod::unspec, "unspec"},
            std::pair{IOMethod::output_put, "output_put"},
            std::pair{IOMethod::input_peek, "input_peek"},

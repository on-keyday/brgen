...
namespace brgen::ast {
    ...
    template <>
    constexpr std::array<std::pair<Follow, std::string_view>, 16> make_enum_array<Follow>() {
        return {
    ...
    template <>
    constexpr std::array<std::pair<Follow, std::string_view>, 16> make_enum_name_array<Follow>() {
        return {
            std::pair{Follow::unknown, "unknown"},
            std::pair{Follow::reference, "reference"},
            std::pair{Follow::define_variable, "define_variable"},
